                    ...
                    {actionItems.map((item, index) => {
                        ...
                        return (
                            <motion.a
                                ...
                                data-hover="true"
                            >
                                <Icon className="w-5 h-5 text-[#a855f7] group-hover:text-white transition-colors" />
                                    ...
                                    {actionItems.map((item, index) => {
                                        ...
                                        return (
                                            <motion.a
                                                key={item.label}
                                                href={item.href}
                                                className="flex items-center justify-center gap-2 py-3 px-4 rounded-xl bg-[#a855f7] text-[#050505] font-heading text-sm"
                                                initial={{ opacity: 0, y: 20 }}
                                                animate={{ opacity: 1, y: 0 }}
